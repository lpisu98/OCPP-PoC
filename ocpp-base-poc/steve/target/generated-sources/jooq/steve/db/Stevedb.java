...
public class Stevedb extends SchemaImpl {
     ...
     */
    public final ChargeBoxCertificateInstalled CHARGE_BOX_CERTIFICATE_INSTALLED = ChargeBoxCertificateInstalled.CHARGE_BOX_CERTIFICATE_INSTALLED;

    /**
     * The table <code>stevedb.charge_box_certificate_signed</code>.
     */
    public final ChargeBoxCertificateSigned CHARGE_BOX_CERTIFICATE_SIGNED = ChargeBoxCertificateSigned.CHARGE_BOX_CERTIFICATE_SIGNED;

    /**
     * The table <code>stevedb.charge_box_certificate_signed_view</code>.
     */
    public final ChargeBoxCertificateSignedView CHARGE_BOX_CERTIFICATE_SIGNED_VIEW = ChargeBoxCertificateSignedView.CHARGE_BOX_CERTIFICATE_SIGNED_VIEW;

    /**
     * The table <code>stevedb.charge_box_firmware_update_event</code>.
     */
    public final ChargeBoxFirmwareUpdateEvent CHARGE_BOX_FIRMWARE_UPDATE_EVENT = ChargeBoxFirmwareUpdateEvent.CHARGE_BOX_FIRMWARE_UPDATE_EVENT;

    /**
     * The table <code>stevedb.charge_box_firmware_update_job</code>.
     */
    public final ChargeBoxFirmwareUpdateJob CHARGE_BOX_FIRMWARE_UPDATE_JOB = ChargeBoxFirmwareUpdateJob.CHARGE_BOX_FIRMWARE_UPDATE_JOB;

    /**
     * The table <code>stevedb.charge_box_log_upload_event</code>.
     */
    public final ChargeBoxLogUploadEvent CHARGE_BOX_LOG_UPLOAD_EVENT = ChargeBoxLogUploadEvent.CHARGE_BOX_LOG_UPLOAD_EVENT;

    /**
     * The table <code>stevedb.charge_box_log_upload_job</code>.
     */
    public final ChargeBoxLogUploadJob CHARGE_BOX_LOG_UPLOAD_JOB = ChargeBoxLogUploadJob.CHARGE_BOX_LOG_UPLOAD_JOB;

    /**
     * The table <code>stevedb.charge_box_security_event</code>.
     */
    public final ChargeBoxSecurityEvent CHARGE_BOX_SECURITY_EVENT = ChargeBoxSecurityEvent.CHARGE_BOX_SECURITY_EVENT;

    /**
     * The table <code>stevedb.charge_box_status_event</code>.
     */
    public final ChargeBoxStatusEvent CHARGE_BOX_STATUS_EVENT = ChargeBoxStatusEvent.CHARGE_BOX_STATUS_EVENT;
     ...
     */
    public final UserOcppTag USER_OCPP_TAG = UserOcppTag.USER_OCPP_TAG;
    ...
    public final List<Table<?>> getTables() {
        return Arrays.asList(
            ...
            ChargeBoxCertificateInstalled.CHARGE_BOX_CERTIFICATE_INSTALLED,
            ChargeBoxCertificateSigned.CHARGE_BOX_CERTIFICATE_SIGNED,
            ChargeBoxCertificateSignedView.CHARGE_BOX_CERTIFICATE_SIGNED_VIEW,
            ChargeBoxFirmwareUpdateEvent.CHARGE_BOX_FIRMWARE_UPDATE_EVENT,
            ChargeBoxFirmwareUpdateJob.CHARGE_BOX_FIRMWARE_UPDATE_JOB,
            ChargeBoxLogUploadEvent.CHARGE_BOX_LOG_UPLOAD_EVENT,
            ChargeBoxLogUploadJob.CHARGE_BOX_LOG_UPLOAD_JOB,
            ChargeBoxSecurityEvent.CHARGE_BOX_SECURITY_EVENT,
            ChargeBoxStatusEvent.CHARGE_BOX_STATUS_EVENT,
