...
public class OcppTagActivity extends TableImpl<OcppTagActivityRecord> {
     ...
     */
    public final TableField<OcppTagActivityRecord, Integer> OCPP_TAG_PK = createField(DSL.name("ocpp_tag_pk"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<OcppTagActivityRecord, String> PARENT_ID_TAG = createField(DSL.name("parent_id_tag"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.ocpp_tag_activity.expiry_date</code>.
     */
    public final TableField<OcppTagActivityRecord, DateTime> EXPIRY_DATE = createField(DSL.name("expiry_date"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column
     * <code>stevedb.ocpp_tag_activity.max_active_transaction_count</code>.
     */
    public final TableField<OcppTagActivityRecord, Integer> MAX_ACTIVE_TRANSACTION_COUNT = createField(DSL.name("max_active_transaction_count"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.ocpp_tag_activity.note</code>.
     */
    public final TableField<OcppTagActivityRecord, String> NOTE = createField(DSL.name("note"), SQLDataType.CLOB(16777215).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "");

    /**
     * The column
     * <code>stevedb.ocpp_tag_activity.active_transaction_count</code>.
     */
    public final TableField<OcppTagActivityRecord, Long> ACTIVE_TRANSACTION_COUNT = createField(DSL.name("active_transaction_count"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>stevedb.ocpp_tag_activity.in_transaction</code>.
     */
    public final TableField<OcppTagActivityRecord, Boolean> IN_TRANSACTION = createField(DSL.name("in_transaction"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>stevedb.ocpp_tag_activity.blocked</code>.
     */
    public final TableField<OcppTagActivityRecord, Boolean> BLOCKED = createField(DSL.name("blocked"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BOOLEAN)), this, "");
