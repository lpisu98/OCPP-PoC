...
import jooq.steve.db.tables.UserOcppTag.UserOcppTagPath;
...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, Integer> ADDRESS_PK = createField(DSL.name("address_pk"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.user.first_name</code>.
     */
    public final TableField<UserRecord, String> FIRST_NAME = createField(DSL.name("first_name"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.user.last_name</code>.
     */
    public final TableField<UserRecord, String> LAST_NAME = createField(DSL.name("last_name"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.user.birth_day</code>.
     */
    public final TableField<UserRecord, LocalDate> BIRTH_DAY = createField(DSL.name("birth_day"), SQLDataType.DATE.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.DATE)), this, "", new DateConverter());

    /**
     * The column <code>stevedb.user.sex</code>.
     */
    public final TableField<UserRecord, String> SEX = createField(DSL.name("sex"), SQLDataType.CHAR(1).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CHAR)), this, "");

    /**
     * The column <code>stevedb.user.phone</code>.
     */
    public final TableField<UserRecord, String> PHONE = createField(DSL.name("phone"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.user.e_mail</code>.
     */
    public final TableField<UserRecord, String> E_MAIL = createField(DSL.name("e_mail"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.user.notification_features</code>. comma
     * separated list
     */
    public final TableField<UserRecord, String> NOTIFICATION_FEATURES = createField(DSL.name("notification_features"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "comma separated list");

    /**
     * The column <code>stevedb.user.note</code>.
     */
    public final TableField<UserRecord, String> NOTE = createField(DSL.name("note"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "");

    /**
     * The column <code>stevedb.user.created_at</code>.
     */
    public final TableField<UserRecord, DateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMP(6).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp(6)"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.user.updated_at</code>.
     */
    public final TableField<UserRecord, DateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMP(6).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp(6)"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());
    ...
    public List<ForeignKey<UserRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FK_USER_ADDRESS_APK);
    }
    ...
    private transient UserOcppTagPath _userOcppTag;

    /**
     * Get the implicit to-many join path to the
     * <code>stevedb.user_ocpp_tag</code> table
     */
    public UserOcppTagPath userOcppTag() {
        if (_userOcppTag == null)
            _userOcppTag = new UserOcppTagPath(this, null, Keys.USER_OCPP_TAG_IBFK_1.getInverseKey());
     ...
     * <code>stevedb.ocpp_tag</code> table
     */
    public OcppTagPath ocppTag() {
        return userOcppTag().ocppTag();
    }
