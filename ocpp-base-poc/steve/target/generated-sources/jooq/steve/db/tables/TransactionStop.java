...
public class TransactionStop extends TableImpl<TransactionStopRecord> {
     ...
     */
    public final TableField<TransactionStopRecord, TransactionStopEventActor> EVENT_ACTOR = createField(DSL.name("event_actor"), SQLDataType.VARCHAR(7).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)).asEnumDataType(TransactionStopEventActor.class), this, "");
     ...
     */
    public final TableField<TransactionStopRecord, String> STOP_REASON = createField(DSL.name("stop_reason"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");
