...
public class OcppTag extends TableImpl<OcppTagRecord> {
     ...
     */
    public final TableField<OcppTagRecord, String> PARENT_ID_TAG = createField(DSL.name("parent_id_tag"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.ocpp_tag.expiry_date</code>.
     */
    public final TableField<OcppTagRecord, DateTime> EXPIRY_DATE = createField(DSL.name("expiry_date"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.ocpp_tag.max_active_transaction_count</code>.
     */
    public final TableField<OcppTagRecord, Integer> MAX_ACTIVE_TRANSACTION_COUNT = createField(DSL.name("max_active_transaction_count"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.ocpp_tag.note</code>.
     */
    public final TableField<OcppTagRecord, String> NOTE = createField(DSL.name("note"), SQLDataType.CLOB(16777215).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "");

    /**
     * The column <code>stevedb.ocpp_tag.created_at</code>.
     */
    public final TableField<OcppTagRecord, DateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMP(6).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp(6)"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.ocpp_tag.updated_at</code>.
     */
    public final TableField<OcppTagRecord, DateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMP(6).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp(6)"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());
    ...
    public UserOcppTagPath userOcppTag() {
        if (_userOcppTag == null)
            _userOcppTag = new UserOcppTagPath(this, null, Keys.USER_OCPP_TAG_IBFK_2.getInverseKey());

        return _userOcppTag;
    }

    /**
     * Get the implicit many-to-many join path to the <code>stevedb.user</code>
     * table
     */
    public UserPath user() {
        return userOcppTag().user();
    }
