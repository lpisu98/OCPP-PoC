...
public class ChargingSchedulePeriod extends TableImpl<ChargingSchedulePeriodRecord> {
     ...
     */
    public final TableField<ChargingSchedulePeriodRecord, Integer> NUMBER_PHASES = createField(DSL.name("number_phases"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");
