...
public class Settings extends TableImpl<SettingsRecord> {
     ...
     */
    public final TableField<SettingsRecord, Integer> HEARTBEAT_INTERVAL_IN_SECONDS = createField(DSL.name("heartbeat_interval_in_seconds"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.settings.hours_to_expire</code>.
     */
    public final TableField<SettingsRecord, Integer> HOURS_TO_EXPIRE = createField(DSL.name("hours_to_expire"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.settings.mail_enabled</code>.
     */
    public final TableField<SettingsRecord, Boolean> MAIL_ENABLED = createField(DSL.name("mail_enabled"), SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>stevedb.settings.mail_host</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_HOST = createField(DSL.name("mail_host"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_username</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_USERNAME = createField(DSL.name("mail_username"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_password</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_PASSWORD = createField(DSL.name("mail_password"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_from</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_FROM = createField(DSL.name("mail_from"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_protocol</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_PROTOCOL = createField(DSL.name("mail_protocol"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("'smtp'"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_port</code>.
     */
    public final TableField<SettingsRecord, Integer> MAIL_PORT = createField(DSL.name("mail_port"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("25"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.settings.mail_recipients</code>. comma separated
     * list of email addresses
     */
    public final TableField<SettingsRecord, String> MAIL_RECIPIENTS = createField(DSL.name("mail_recipients"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "comma separated list of email addresses");

    /**
     * The column <code>stevedb.settings.notification_features</code>. comma
     * separated list
     */
    public final TableField<SettingsRecord, String> NOTIFICATION_FEATURES = createField(DSL.name("notification_features"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "comma separated list");
