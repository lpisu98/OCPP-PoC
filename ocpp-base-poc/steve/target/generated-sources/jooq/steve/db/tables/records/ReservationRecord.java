...
public class ReservationRecord extends UpdatableRecordImpl<ReservationRecord> {
    ...
    /**
     * Setter for <code>stevedb.reservation.created_at</code>.
     */
    public ReservationRecord setCreatedAt(DateTime value) {
        set(7, value);
        return this;
    }

    /**
     * Getter for <code>stevedb.reservation.created_at</code>.
     */
    ...
    /**
     * Setter for <code>stevedb.reservation.updated_at</code>.
     */
    public ReservationRecord setUpdatedAt(DateTime value) {
        set(8, value);
        return this;
    }

    /**
     * Getter for <code>stevedb.reservation.updated_at</code>.
     */
     ...
     */
    public ReservationRecord(Integer reservationPk, Integer connectorPk, Integer transactionPk, String idTag, DateTime startDatetime, DateTime expiryDatetime, String status, DateTime createdAt, DateTime updatedAt) {
        super(Reservation.RESERVATION);
