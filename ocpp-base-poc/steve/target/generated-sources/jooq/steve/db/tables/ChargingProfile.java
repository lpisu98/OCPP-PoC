...
public class ChargingProfile extends TableImpl<ChargingProfileRecord> {
     ...
     */
    public final TableField<ChargingProfileRecord, String> RECURRENCY_KIND = createField(DSL.name("recurrency_kind"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.charging_profile.valid_from</code>.
     */
    public final TableField<ChargingProfileRecord, DateTime> VALID_FROM = createField(DSL.name("valid_from"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.charging_profile.valid_to</code>.
     */
    public final TableField<ChargingProfileRecord, DateTime> VALID_TO = createField(DSL.name("valid_to"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.charging_profile.duration_in_seconds</code>.
     */
    public final TableField<ChargingProfileRecord, Integer> DURATION_IN_SECONDS = createField(DSL.name("duration_in_seconds"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.charging_profile.start_schedule</code>.
     */
    public final TableField<ChargingProfileRecord, DateTime> START_SCHEDULE = createField(DSL.name("start_schedule"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());
     ...
     */
    public final TableField<ChargingProfileRecord, BigDecimal> MIN_CHARGING_RATE = createField(DSL.name("min_charging_rate"), SQLDataType.DECIMAL(15, 1).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>stevedb.charging_profile.description</code>.
     */
    public final TableField<ChargingProfileRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.charging_profile.note</code>.
     */
    public final TableField<ChargingProfileRecord, String> NOTE = createField(DSL.name("note"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "");

    /**
     * The column <code>stevedb.charging_profile.created_at</code>.
     */
    public final TableField<ChargingProfileRecord, DateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMP(6).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp(6)"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.charging_profile.updated_at</code>.
     */
    public final TableField<ChargingProfileRecord, DateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMP(6).nullable(false).defaultValue(DSL.field(DSL.raw("current_timestamp(6)"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());
