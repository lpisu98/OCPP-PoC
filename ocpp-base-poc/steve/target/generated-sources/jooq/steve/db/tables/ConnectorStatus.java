...
public class ConnectorStatus extends TableImpl<ConnectorStatusRecord> {
     ...
     */
    public final TableField<ConnectorStatusRecord, DateTime> STATUS_TIMESTAMP = createField(DSL.name("status_timestamp"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.connector_status.status</code>.
     */
    public final TableField<ConnectorStatusRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.connector_status.error_code</code>.
     */
    public final TableField<ConnectorStatusRecord, String> ERROR_CODE = createField(DSL.name("error_code"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.connector_status.error_info</code>.
     */
    public final TableField<ConnectorStatusRecord, String> ERROR_INFO = createField(DSL.name("error_info"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.connector_status.vendor_id</code>.
     */
    public final TableField<ConnectorStatusRecord, String> VENDOR_ID = createField(DSL.name("vendor_id"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.connector_status.vendor_error_code</code>.
     */
    public final TableField<ConnectorStatusRecord, String> VENDOR_ERROR_CODE = createField(DSL.name("vendor_error_code"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");
