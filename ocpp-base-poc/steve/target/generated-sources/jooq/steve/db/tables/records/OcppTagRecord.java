...
public class OcppTagRecord extends UpdatableRecordImpl<OcppTagRecord> {
    ...
    /**
     * Setter for <code>stevedb.ocpp_tag.created_at</code>.
     */
    public OcppTagRecord setCreatedAt(DateTime value) {
        set(6, value);
        return this;
    }

    /**
     * Getter for <code>stevedb.ocpp_tag.created_at</code>.
     */
    ...
    /**
     * Setter for <code>stevedb.ocpp_tag.updated_at</code>.
     */
    public OcppTagRecord setUpdatedAt(DateTime value) {
        set(7, value);
        return this;
    }

    /**
     * Getter for <code>stevedb.ocpp_tag.updated_at</code>.
     */
     ...
     */
    public OcppTagRecord(Integer ocppTagPk, String idTag, String parentIdTag, DateTime expiryDate, Integer maxActiveTransactionCount, String note, DateTime createdAt, DateTime updatedAt) {
        super(OcppTag.OCPP_TAG);
